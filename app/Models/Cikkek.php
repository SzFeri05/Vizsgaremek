...
class Cikkek extends Model
{
    ...
    {
        return DB::select("SELECT *, diakok.felhasznalonev FROM cikkek INNER JOIN diakok ON cikkek.diak_id = diakok.id ORDER BY cikkek.datum DESC LIMIT " . $limit . " OFFSET " . $offset);
    }
