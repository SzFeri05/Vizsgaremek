...
async function cikkekBetoltese(oldal) {
    ...
    if (oldal === 1) {
        cikkekHelye.innerHTML = '<h1 class="mb-5" style="text-decoration: underline; font-variant: small-caps; font-size: 4rem; height: fit-content;">Digitális Iskolaújság</h1><div class="col col-6 d-flex justify-content-center" style="height: 88%;"><!--Alap adatok a felhasználóról, tájékoztató--><div class="row"><div class="col col-12" style="height: 50%;"><fieldset><legend>Köszöntünk <span id="adatNev"></span>!</legend><ul><li>Iskola: <strong><span id="adatIskola"></span></strong></li><li>E-mail cím: <strong><span id="adatEmail"></span></strong></li><li>Felhasználónév: <strong><span id="adatFelhasz"></span></strong></li><li>Osztály: <strong><span id="adatOsztaly"></span></strong></li></ul></fieldset></div><div class="col col-12" style="height: 50%;"><fieldset><legend>Az oldalról:</legend><p>Ez egy digitális iskola újság alapvetően. A neve talán leír mindent, amit tudni kell. A diákok tudnak regisztrálni, cikekket feltölteni és más diákok által feltöltött cikkeket olvasgatni, böngészni. Ahhoz hogy a Te cikked is megjelenjen az oldalon, először az iskolád admin felhasználójának el kell fogadni!</p></fieldset></div></div></div><div class="col col-6"><fieldset><legend>Rólunk:</legend><figure><img src="./img/alkotok.jpeg" id="alkotok" class="img-thumbnail nagyitosKep" alt="Az oldal készítői" title="Az oldal készítői" style="width: 50%; height: auto;"><figure>Szammer Ferenc - Tivadari Soma</figure></figure><p>A digitális iskolaújság büszke alkotói. Az oldal a 2024/2025-ös tanévben készült, amikor A Veszprémi SZC Ipari Technikumba jártunk végzős szoftverfejlesztő- és tesztelőként. Célunk az volt, hogy a hagyományos papírújságot leváltsuk, megőrizve a diákok hozzáférését a legfrissebb hírekhez az iskolájukban!</p></fieldset></div>';
    ...
    for (const poszt of posztok) {
      ...
      if(karakterSzam >= 200)
      {
        ...
        if(poszt.kep != "data:image\/ismeretlen;base64,")
        {
            ...
            p.innerHTML = poszt.szoveg.substring(0, 52) + "...";
        ...
        else
        {
            ...
            p.innerHTML = poszt.szoveg.substring(0, 202) + "...";
