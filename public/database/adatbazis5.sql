...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Már 24. 12:55
...
(48, 'Ez a legujjabb versem', 'Van egy kék tó a fák alatt,\r\nHa beleteszem, lehűti a lábamat.\r\nSzájber gyerek kérjél bocsánatot,\r\nMert nem mutatom meg a kacsámat ott!', 2, '2025-03-24 12:18:19', 1, 2),
(55, 'asdasda', 'dsadasdas', 2, '2025-03-24 12:29:22', 1, 2),
(57, 'asdasdas', 'dasdadas', 2, '2025-03-24 12:29:30', 1, 2),
(63, 'asadasd', 'asdas', 2, '2025-03-24 12:36:37', 1, 2),
(69, 'dasdasdas', 'dasdasdasdasd', 2, '2025-03-24 12:39:54', 1, 2),
(70, 'asdasdasdasd', 'asdasdasd', 2, '2025-03-24 12:40:46', 1, 2),
(73, 'dasdasadsas', 'asdasdas', 2, '2025-03-24 12:40:56', 1, 2),
(74, 'dasdasd', 'asdasdasdas', 2, '2025-03-24 12:41:51', 1, 2),
(83, 'asdasdasd', 'sadasdasd', 2, '2025-03-24 12:49:45', 1, 2),
(84, 'asdasdas', 'dasdasdsa', 2, '2025-03-24 12:49:49', 1, 2),
(88, 'dasdasda', 'sdasdasd', 2, '2025-03-24 12:54:15', 1, 2),
(89, 'asdasdas', 'dasdasda', 2, '2025-03-24 12:54:32', 1, 2);
...
CREATE TABLE `kepek` (
  ...
  `kepMime` varchar(255) DEFAULT NULL,
  `kepAdat` longblob DEFAULT NULL,
  `feltoltesDatuma` timestamp NOT NULL DEFAULT current_timestamp(),
  `elfogadva` tinyint(4) DEFAULT NULL,
  `feltoltoId` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
